                ...
                <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm">
                    ...
                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        ...
                        <div className="col-span-full sm:col-span-3 grid grid-cols-1 sm:grid-cols-3 justify-between">
                            <div className='mb-2'>
                                <label className='label text-lg capitalize'>Full name</label>
                                <p className='text-sm'>Mayraj Uddin</p>
                            </div>
                            <div className='mb-2'>
                                <label className='label text-lg capitalize'>Email</label>
                                <p className='text-sm'>mayraj@gmail.com</p>
                            </div>
                            <div className='mb-2'>
                                <label className='label text-lg  capitalize'>phone</label>
                                <p className='text-sm'>01628649295</p>
                            </div>
                            <div className='mb-2'>
                                <label className='label text-lg  capitalize'>Date of birth</label>
                                <p className='text-sm'> 11-12-1999</p>
                            </div>
                            <div className='mb-2'>
                                <label className='label text-lg  capitalize'>Gender</label>
                                <p className='text-sm'> Male</p>
                            </div>
                            <div className='mb-2'>
                                <label className='label text-lg  capitalize'>Blood Group</label>
